...
- The reference data in the app and in the Copilot's prompt has since been corrected and dated. Re-running the fee questions against the corrected figures (a "Run 3") is still to do.
